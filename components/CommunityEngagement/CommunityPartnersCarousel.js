...
const CommunityPartnersCarousel = () => {
    const responsive = {
        desktop: {
    ...
    return (
        <Container className='py-5'>
            <Col className='text-center'>
                <h1 className='text-center pb-3 d-inline-block ' style={{ borderBottom: '2px solid #639563' }} >
                    Partners
                </h1>
            </Col>
...
export default CommunityPartnersCarousel